#' Convert IBDprob to gDataMPP
#'
#' Function for converting an object of class IBDprob (computed or imported
#' using statgenIBD) to an object of class gDataMPP.
#'
#' @param IBDprob An object of class IBDprob
...
#'
#' @export
convertIBDtoMPP <- function(IBDprob,
                            pheno) {
  ...
  res <- createGDataMPP(geno = IBDprob$markers, map = IBDprob$map,
