...
As an example we use a barley population described in @Liller2017-jz. This MPP design consists of 5 parents. 4 Wild parents were crossed with the cultivar Morex and then back crossed with Morex once. Individuals from the four families from the back crosses were then crossed with each other as in a full diallel design, which generated six F6 families through five generations of selfing. The trait of interest for this population is awn length ("Awn_length"). As for the NAM population, the data for this population is available in zipped format in the package.
