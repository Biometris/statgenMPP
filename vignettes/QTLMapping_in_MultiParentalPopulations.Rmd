...
Performing SIM and CIM for imported RABBIT output works in the same way as for IBD probabilities computed directly in the package. Since a full scan would take long we restrict the maximum number of cofactors to one to only detect the most significant QTL.
